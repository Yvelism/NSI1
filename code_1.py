...
largeur_barre_max=100
hauteur_barre=15#largeur et hauteur des barres de vie
...
def ecran_accueil():
    ...
    menu = MenuDeroulant(100, 200, 200, 30, ['feu','eau','terre','air'])
...
def jeu(arene):
    ...
    while continuer:
        ...
        ecran.blit(brute1, brute1.get_position())
        ecran.blit(brute2, brute2.get_position())
...
brute2=perso("luigi","images/brute1.png", 250,240,500,500,(600,550))

brute1=perso("mario","images/brute2.png", 250, 120, 500, 500, (100,550))
