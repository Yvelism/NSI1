...
#création des persos
pit=perso("Pit","images/pit.png", 250,250, 80, 80, (600,300))
mario=perso("Mario","images/mario.png", 800, 800, 50, 50, (100,300))     
ike = perso("Ike","images/ike.png",900, 900, 40, 40, (50,300))
#liste des persos disponibles 
chperso1=["mario","pit","ike"] #en str pcq sinon prblm plus bas
chperso2=["mario","pit","ike"]# g essayé les deux ct plus simple
