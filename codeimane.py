...
class MenuDeroulant:
    ...
    def afficher_selectionp(self):
            #imgperso = pygame.image.load("images/"+self.selection+".png").convert()
...
pit = pygame.image.load("images/pit.png").convert_alpha()
pit = pygame.transform.scale(pit, (150,150))
nom_pit="Pit"
nom2 = police.render(nom_pit, True, couleur2)
x_barre2=600
y_barre2=550

ike = pygame.image.load("images/ike.png").convert_alpha()
ike = pygame.transform.scale(ike, (150,150))
nom_ike="Ike"
nom3 = police.render(nom_ike, True, couleur2)
x_barre2=200
y_barre2=550
