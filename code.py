...
brute1=perso("Luigi","images/brute1.png", 250,240,500,500, (600,300))
mario1=perso("Mario","images/mario1.png", 250, 120, 500, 500, (100,300))     

pos_mario1=mario1.get_position()
pos_brute1=brute1.get_position()
...
brute1 = pygame.image.load("images/mario2.jpeg").convert_alpha()
#Redimension de l'image
brute1 = pygame.transform.scale(brute1, (150, 150))

nom_brute1 = "Mario"
nom1 = police.render(nom_brute1, True, couleur1)
x_barre1 = 100
y_barre1 = 550
...
nom2 = police.render(nom_brute2, True, couleur2)
x_barre2=600
y_barre2=550
